...
mod tests {
    ...
    fn test_stress_categories() {
        assert_eq!(StressCategory::from_utci(-45.0), StressCategory::ExtremeColdStress);
        assert_eq!(StressCategory::from_utci(-30.0), StressCategory::VeryStrongColdStress);
        assert_eq!(StressCategory::from_utci(-15.0), StressCategory::StrongColdStress);
        assert_eq!(StressCategory::from_utci(-5.0), StressCategory::ModerateColdStress);
        assert_eq!(StressCategory::from_utci(5.0), StressCategory::SlightColdStress);
        assert_eq!(StressCategory::from_utci(20.0), StressCategory::NoThermalStress);
        assert_eq!(StressCategory::from_utci(30.0), StressCategory::ModerateHeatStress);
        assert_eq!(StressCategory::from_utci(35.0), StressCategory::StrongHeatStress);
        assert_eq!(StressCategory::from_utci(42.0), StressCategory::VeryStrongHeatStress);
        assert_eq!(StressCategory::from_utci(50.0), StressCategory::ExtremeHeatStress);
    }
}
